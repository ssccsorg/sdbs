...
def main(argv: list[str] | None = None) -> None:
    ...
    render_parser = subparsers.add_parser(
        ...
        "a build input rather than preprocessing, so it is written for the "
        "selected documents when it is missing or stale, and a header that names "
        "a metadata macro without referencing that file has the reference "
        "inserted.\n\n"
